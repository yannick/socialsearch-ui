...
angular.module('services.facebookApi', [])
      ...
      var facebookApiFactory = function (apiAccessToken) {
              ...
              _.each(data, function (dataItem, index) {
                ...
                if (dataItem === null) {
                  ...
                  if (dataItem.body.error !== undefined) {
                    batchCallbacks[index].errorCallback(dataItem.body);
                  } else {
                    batchCallbacks[index].successCallback(dataItem.body);
                  }
                }
              });
            })
        ...
        function startQueue() {
          if (queueTimeout === null) {
            queueTimeout = window.setTimeout(processQueue, apiRateLimit);
          }
        }
            ...
            _.each(connections, function (facebookObject) {
              ...
              facebookApi.get(requestUrl,
                ...
                function (data) {
                  ...
                  // Completed callback
                  if (progress === 1) {
                    completedCallback(facebookObjectId);
                  }
                },
                // Error callback
                function (data) {
